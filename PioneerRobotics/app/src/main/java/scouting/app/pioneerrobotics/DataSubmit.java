...
class AnalyticsData {
    ...
    boolean foundationMovedOut, endParked;
    int endScore;
    String teamName, eventName, role, startSide;
    boolean foundationMoved, parked;
